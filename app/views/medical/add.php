    ...
    <div class="card-body">
        ...
        <form method="POST" action="?url=medical/store" novalidate>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    <span class="icon" aria-hidden="true">💊</span>
                    <textarea id="treatment" name="treatment" rows="4" placeholder="Prescribed medication, follow-up steps..."
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    <span class="icon" aria-hidden="true">📝</span>
                    <textarea id="notes" name="notes" rows="3" placeholder="Any extra observations..."><?php echo htmlspecialchars($old['notes'] ?? ''); ?></textarea>
                </div>
            </div>
