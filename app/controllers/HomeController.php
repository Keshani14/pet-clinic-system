    ...
    public function serviceDetail() {
        ...
        $services = [
            'pain-control' => [
                ...
                'paragraphs' => [
                    'Pain management is a cornerstone of compassionate veterinary care. At PetSync, we believe every animal deserves to live comfortably and free from unnecessary suffering. Our team of specialists uses the latest multimodal pain control techniques to ensure your pet recovers quickly and comfortably.',
